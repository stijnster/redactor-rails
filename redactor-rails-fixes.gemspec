...
Gem::Specification.new do |gem|
  ...
  gem.description   = "This gem maintains fixes to support the original gem. The redactor-rails gem integrates the Redactor editor"
  gem.summary       = ""
